...
def evaluate_cluster(cluster_id):
    model_path     = f"Models_XGBoost/xgb_cluster{cluster_id}.pkl"
    feat_path      = f"Models_XGBoost/featnames_cluster{cluster_id}.pkl"
    X_test_path    = f"Models_XGBoost/X_test{cluster_id}.pkl"
    y_test_path    = f"Models_XGBoost/y_test{cluster_id}.pkl"
